...
<div style="height:80px;">
	...
	<form action="pedidoporfecha.php" method="post">
		...
		<input type="text" name="fechainicial" id="fecha1">
		<label>Fecha Final:</label>
		<input type="text" name="fechafinal" id="fecha2">
		<input type="submit" value="Buscar">
	</form>
</div>
...
$peticion = "SELECT * FROM pedidos, clientes WHERE pedidos.idcliente=clientes.idcliente AND pedidos.fecha BETWEEN STR_TO_DATE('".$_POST['fechainicial']."', '%m/%d/%Y') AND STR_TO_DATE('".$_POST['fechafinal']." 23:59:59', '%m/%d/%Y %H:%i:%s') ORDER BY estado, fecha ASC";
