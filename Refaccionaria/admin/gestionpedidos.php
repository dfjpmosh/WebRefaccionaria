...
$peticion = "SELECT * FROM pedidos, clientes WHERE pedidos.idcliente=clientes.idcliente ORDER BY estado, fecha ASC";
...
while($fila = mysqli_fetch_array($resultado))
{
	...
	if($fila['estado'] == 0)
	{
		echo '<td><a href="../php/pedidoservido.php?id='.$fila['idpedido'].'"><button>Pedido Servido</button></a></td>
