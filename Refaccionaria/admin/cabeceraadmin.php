...
<html lang="es">
	...
	<div id="login">
		<p>
	    	<label for="user_name"><h5>NO SOMOS UNA REFACCIONARIA SOMOS UNA SOLUCION PARA TU AUTOMOVIL</h5></label>			
	    </p>
		<ul class="nav">
			<li><a href="index.php"><strong>Inicio</strong></a></li>
			<li><a href="gestionpedidos.php"><strong>Pedidos</strong></a></li>
			<li><a href="gestionclientes.php"><strong>Clientes</strong></a></li>
			<li><a href="gestionproductos.php"><strong>Productos</strong></a></li>
		</ul>
