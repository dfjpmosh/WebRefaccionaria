...
--
-- Servidor: localhost
-- Tiempo de generación: 14-10-2015 a las 07:31:52
...
('def', 'bdrefaccionaria', 'clientes', 'idcliente', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'user', 2, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'pass', 3, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'nombre', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'apellidos', 5, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'telefono', 6, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'correo', 7, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'dircalle', 8, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'dirnum', 9, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'clientes', 'dircol', 10, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'detallepedido', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'detallepedido', 'idpedido', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'detallepedido', 'idproducto', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'detallepedido', 'cantidad', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 'idproducto', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 'imagen', 3, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 'titulo', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 'descripcion', 5, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'pedidos', 'idpedido', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'pedidos', 'idcliente', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'pedidos', 'fecha', 3, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'pedidos', 'estado', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'idproducto', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'nombre', 2, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'descripcion', 3, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'precio', 4, NULL, 'YES', 'float', NULL, NULL, 10, 2, NULL, NULL, 'float(10,2)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'existencias', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'categoria', 6, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'promocion', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'preciopromo', 8, NULL, 'YES', 'float', NULL, NULL, 10, 2, NULL, NULL, 'float(10,2)', '', '', 'select,insert,update,references', ''),
('def', 'bdrefaccionaria', 'productos', 'activado', 9, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
...
('def', 'tiendaonline', 'clientes', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'nombre', 2, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'apellidos', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'email', 4, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'usuario', 5, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'contrasena', 6, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'telefono', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(12)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'movil', 8, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(12)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'fax', 9, NULL, 'YES', 'varchar', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'direccioncalle', 10, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'codigopostal', 11, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'poblacion', 12, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'pais', 13, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'clientes', 'dninif', 14, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'imagenesproductos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'imagenesproductos', 'idproducto', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'imagenesproductos', 'imagen', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'imagenesproductos', 'titulo', 4, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'imagenesproductos', 'descripcion', 5, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'lineaspedido', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'lineaspedido', 'idpedido', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'lineaspedido', 'idproducto', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'lineaspedido', 'unidades', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'pedidos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'pedidos', 'idcliente', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'pedidos', 'fecha', 3, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'pedidos', 'estado', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'nombre', 2, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'descripcion', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'precio', 4, NULL, 'YES', 'decimal', NULL, NULL, 30, 2, NULL, NULL, 'decimal(30,2)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'peso', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'longitud', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'anchura', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'altura', 8, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'existencias', 9, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', '', '', 'select,insert,update,references', ''),
('def', 'tiendaonline', 'productos', 'activado', 10, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', '');
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '379'),
('CREATED_TMP_DISK_TABLES', '163'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '764'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '48'),
('HANDLER_READ_FIRST', '368'),
('HANDLER_READ_KEY', '655'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '2755'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '732'),
('HANDLER_READ_RND_NEXT', '14266'),
('HANDLER_ROLLBACK', '9'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '382'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '19810'),
('INNODB_BUFFER_POOL_READS', '395'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '724'),
('INNODB_DATA_FSYNCS', '165'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8654848'),
('INNODB_DATA_READS', '405'),
('INNODB_DATA_WRITES', '319'),
('INNODB_DATA_WRITTEN', '6340096'),
('INNODB_DBLWR_PAGES_WRITTEN', '191'),
('INNODB_DBLWR_WRITES', '30'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '64'),
('INNODB_LOG_WRITES', '70'),
('INNODB_OS_LOG_FSYNCS', '98'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '67072'),
...
('INNODB_ROWS_INSERTED', '54'),
('INNODB_ROWS_READ', '5228'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '12253'),
('UPTIME_SINCE_FLUSH_STATUS', '12253');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\dfjpmodh-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\dfjpmodh-PC.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\dfjpmodh-PC-slow.log'),
...
('def', 'bdrefaccionaria', 'PRIMARY', 'def', 'bdrefaccionaria', 'clientes', 'idcliente', 1, NULL, NULL, NULL, NULL),
('def', 'bdrefaccionaria', 'user', 'def', 'bdrefaccionaria', 'clientes', 'user', 1, NULL, NULL, NULL, NULL),
('def', 'bdrefaccionaria', 'PRIMARY', 'def', 'bdrefaccionaria', 'detallepedido', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'bdrefaccionaria', 'detallepedido_ibfk_1', 'def', 'bdrefaccionaria', 'detallepedido', 'idpedido', 1, 1, 'bdrefaccionaria', 'pedidos', 'idpedido'),
('def', 'bdrefaccionaria', 'detallepedido_ibfk_2', 'def', 'bdrefaccionaria', 'detallepedido', 'idproducto', 1, 1, 'bdrefaccionaria', 'productos', 'idproducto'),
('def', 'bdrefaccionaria', 'PRIMARY', 'def', 'bdrefaccionaria', 'imagenesproductos', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'bdrefaccionaria', 'imagenesproductos_ibfk_1', 'def', 'bdrefaccionaria', 'imagenesproductos', 'idproducto', 1, 1, 'bdrefaccionaria', 'productos', 'idproducto'),
('def', 'bdrefaccionaria', 'PRIMARY', 'def', 'bdrefaccionaria', 'pedidos', 'idpedido', 1, NULL, NULL, NULL, NULL),
('def', 'bdrefaccionaria', 'pedidos_ibfk_1', 'def', 'bdrefaccionaria', 'pedidos', 'idcliente', 1, 1, 'bdrefaccionaria', 'clientes', 'idcliente'),
('def', 'bdrefaccionaria', 'PRIMARY', 'def', 'bdrefaccionaria', 'productos', 'idproducto', 1, NULL, NULL, NULL, NULL),
('def', 'bdrefaccionaria', 'nombre', 'def', 'bdrefaccionaria', 'productos', 'nombre', 1, NULL, NULL, NULL, NULL),
...
('def', 'tiendaonline', 'PRIMARY', 'def', 'tiendaonline', 'clientes', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'tiendaonline', 'PRIMARY', 'def', 'tiendaonline', 'imagenesproductos', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'tiendaonline', 'PRIMARY', 'def', 'tiendaonline', 'lineaspedido', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'tiendaonline', 'PRIMARY', 'def', 'tiendaonline', 'pedidos', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'tiendaonline', 'PRIMARY', 'def', 'tiendaonline', 'productos', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2015-10-14 07:31:53', NULL, NULL, NULL, '', '', NULL),
('def', 'bdrefaccionaria', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 16384, 6291456, '2015-09-20 17:22:35', NULL, NULL, NULL, '', '', NULL),
('def', 'bdrefaccionaria', 'detallepedido', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 35, 468, 16384, NULL, 49152, 6291456, '2015-09-20 17:22:35', NULL, NULL, NULL, '', '', NULL),
('def', 'bdrefaccionaria', 'imagenesproductos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 16384, 6291456, '2015-09-20 17:22:35', NULL, NULL, NULL, '', '', NULL),
('def', 'bdrefaccionaria', 'pedidos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19, 862, 16384, NULL, 16384, 6291456, '2015-09-20 17:22:35', NULL, NULL, NULL, '', '', NULL),
('def', 'bdrefaccionaria', 'productos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 16384, 6291456, '2015-09-20 17:22:35', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 440, 1760, 123848989752688639, 5120, 0, '2012-04-19 14:02:39', '2015-09-20 21:51:23', '2012-04-19 14:02:40', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 14:02:40', '2012-04-19 21:02:40', '2012-04-19 14:02:40', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 60, 364, 281474976710655, 2048, 0, '2012-04-19 14:02:39', '2015-09-20 21:51:23', NULL, NULL, '', '', NULL),
...
('def', 'tiendaonline', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2015-08-29 23:14:38', NULL, NULL, NULL, '', '', NULL),
('def', 'tiendaonline', 'imagenesproductos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2015-08-29 23:14:38', NULL, NULL, NULL, '', '', NULL),
('def', 'tiendaonline', 'lineaspedido', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 28, 585, 16384, NULL, 0, 0, '2015-08-29 23:14:38', NULL, NULL, NULL, '', '', NULL),
('def', 'tiendaonline', 'pedidos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 0, 0, '2015-08-29 23:14:38', NULL, NULL, NULL, '', '', NULL),
('def', 'tiendaonline', 'productos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2015-08-29 23:14:38', NULL, NULL, NULL, '', '', NULL);
...
(378, 'root', 'localhost:53648', 'bdrefaccionaria', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'bdrefaccionaria', 'detallepedido_ibfk_1', 'def', 'bdrefaccionaria', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'detallepedido', 'pedidos'),
('def', 'bdrefaccionaria', 'detallepedido_ibfk_2', 'def', 'bdrefaccionaria', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'detallepedido', 'productos'),
('def', 'bdrefaccionaria', 'imagenesproductos_ibfk_1', 'def', 'bdrefaccionaria', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'imagenesproductos', 'productos'),
('def', 'bdrefaccionaria', 'pedidos_ibfk_1', 'def', 'bdrefaccionaria', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'pedidos', 'clientes');
...
('def', 'bdrefaccionaria', 'utf8', 'utf8_general_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'test', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'tiendaonline', 'utf8', 'utf8_general_ci', NULL);
...
('''tienda''@''localhost''', 'def', 'tiendaonline', 'SELECT', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'INSERT', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'UPDATE', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'DELETE', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'CREATE', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'DROP', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'REFERENCES', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'INDEX', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'ALTER', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'CREATE TEMPORARY TABLES', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'LOCK TABLES', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'EXECUTE', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'CREATE VIEW', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'SHOW VIEW', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'CREATE ROUTINE', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'ALTER ROUTINE', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'EVENT', 'NO'),
('''tienda''@''localhost''', 'def', 'tiendaonline', 'TRIGGER', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'SELECT', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'INSERT', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'UPDATE', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'DELETE', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'CREATE', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'DROP', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'REFERENCES', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'INDEX', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'ALTER', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'CREATE TEMPORARY TABLES', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'LOCK TABLES', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'EXECUTE', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'CREATE VIEW', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'SHOW VIEW', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'CREATE ROUTINE', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'ALTER ROUTINE', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'EVENT', 'NO'),
('''piston''@''localhost''', 'def', 'bdrefaccionaria', 'TRIGGER', 'NO'),
('''''@''%''', 'def', 'test', 'SELECT', 'NO'),
('''''@''%''', 'def', 'test', 'INSERT', 'NO'),
('''''@''%''', 'def', 'test', 'UPDATE', 'NO'),
('''''@''%''', 'def', 'test', 'DELETE', 'NO'),
...
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '382'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7791'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '20240'),
...
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8720384'),
('INNODB_DATA_READS', '409'),
('INNODB_DATA_WRITES', '319'),
('INNODB_DATA_WRITTEN', '6340096'),
('INNODB_DBLWR_PAGES_WRITTEN', '191'),
('INNODB_DBLWR_WRITES', '30'),
...
('def', 'bdrefaccionaria', 'clientes', 0, 'bdrefaccionaria', 'PRIMARY', 1, 'idcliente', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'clientes', 0, 'bdrefaccionaria', 'user', 1, 'user', 'A', 4, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'detallepedido', 0, 'bdrefaccionaria', 'PRIMARY', 1, 'id', 'A', 35, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'detallepedido', 1, 'bdrefaccionaria', 'idpedido', 1, 'idpedido', 'A', 35, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'detallepedido', 1, 'bdrefaccionaria', 'idpedido', 2, 'idproducto', 'A', 35, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'detallepedido', 1, 'bdrefaccionaria', 'idpedido_2', 1, 'idpedido', 'A', 35, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'detallepedido', 1, 'bdrefaccionaria', 'idpedido_2', 2, 'idproducto', 'A', 35, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'detallepedido', 1, 'bdrefaccionaria', 'idproducto', 1, 'idproducto', 'A', 8, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 0, 'bdrefaccionaria', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 1, 'bdrefaccionaria', 'idproducto', 1, 'idproducto', 'A', 5, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'pedidos', 0, 'bdrefaccionaria', 'PRIMARY', 1, 'idpedido', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'pedidos', 1, 'bdrefaccionaria', 'idcliente', 1, 'idcliente', 'A', 4, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'productos', 0, 'bdrefaccionaria', 'PRIMARY', 1, 'idproducto', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bdrefaccionaria', 'productos', 0, 'bdrefaccionaria', 'nombre', 1, 'nombre', 'A', 4, NULL, NULL, 'YES', 'BTREE', '', ''),
...
('def', 'tiendaonline', 'clientes', 0, 'tiendaonline', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'tiendaonline', 'imagenesproductos', 0, 'tiendaonline', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'tiendaonline', 'lineaspedido', 0, 'tiendaonline', 'PRIMARY', 1, 'id', 'A', 28, NULL, NULL, '', 'BTREE', '', ''),
('def', 'tiendaonline', 'pedidos', 0, 'tiendaonline', 'PRIMARY', 1, 'id', 'A', 14, NULL, NULL, '', 'BTREE', '', ''),
('def', 'tiendaonline', 'productos', 0, 'tiendaonline', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-10-14 07:31:53', '2015-10-14 07:31:53', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2015-10-14 07:31:53', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'bdrefaccionaria', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 16384, 6291456, 5, '2015-09-20 17:22:35', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'bdrefaccionaria', 'detallepedido', 'BASE TABLE', 'InnoDB', 10, 'Compact', 35, 468, 16384, 0, 49152, 6291456, 36, '2015-09-20 17:22:35', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'bdrefaccionaria', 'imagenesproductos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 16384, 6291456, 6, '2015-09-20 17:22:35', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'bdrefaccionaria', 'pedidos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 19, 862, 16384, 0, 16384, 6291456, 22, '2015-09-20 17:22:35', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'bdrefaccionaria', 'productos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 16384, 6291456, 6, '2015-09-20 17:22:35', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 4, 440, 1760, 123848989752688639, 5120, 0, NULL, '2012-04-19 14:02:39', '2015-09-20 21:51:23', '2012-04-19 14:02:40', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 21:02:40', '2012-04-19 14:02:40', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 21:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 6, 60, 364, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:39', '2015-09-20 21:51:23', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'tiendaonline', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 4, '2015-08-29 23:14:38', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'tiendaonline', 'imagenesproductos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 6291456, 7, '2015-08-29 23:14:38', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'tiendaonline', 'lineaspedido', 'BASE TABLE', 'InnoDB', 10, 'Compact', 28, 585, 16384, 0, 0, 6291456, 61, '2015-08-29 23:14:38', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'tiendaonline', 'pedidos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 14, 1170, 16384, 0, 0, 6291456, 36, '2015-08-29 23:14:38', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'tiendaonline', 'productos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 5, '2015-08-29 23:14:38', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'bdrefaccionaria', 'PRIMARY', 'bdrefaccionaria', 'clientes', 'PRIMARY KEY'),
('def', 'bdrefaccionaria', 'user', 'bdrefaccionaria', 'clientes', 'UNIQUE'),
('def', 'bdrefaccionaria', 'PRIMARY', 'bdrefaccionaria', 'detallepedido', 'PRIMARY KEY'),
('def', 'bdrefaccionaria', 'detallepedido_ibfk_1', 'bdrefaccionaria', 'detallepedido', 'FOREIGN KEY'),
('def', 'bdrefaccionaria', 'detallepedido_ibfk_2', 'bdrefaccionaria', 'detallepedido', 'FOREIGN KEY'),
('def', 'bdrefaccionaria', 'PRIMARY', 'bdrefaccionaria', 'imagenesproductos', 'PRIMARY KEY'),
('def', 'bdrefaccionaria', 'imagenesproductos_ibfk_1', 'bdrefaccionaria', 'imagenesproductos', 'FOREIGN KEY'),
('def', 'bdrefaccionaria', 'PRIMARY', 'bdrefaccionaria', 'pedidos', 'PRIMARY KEY'),
('def', 'bdrefaccionaria', 'pedidos_ibfk_1', 'bdrefaccionaria', 'pedidos', 'FOREIGN KEY'),
('def', 'bdrefaccionaria', 'PRIMARY', 'bdrefaccionaria', 'productos', 'PRIMARY KEY'),
('def', 'bdrefaccionaria', 'nombre', 'bdrefaccionaria', 'productos', 'UNIQUE'),
...
('def', 'tiendaonline', 'PRIMARY', 'tiendaonline', 'clientes', 'PRIMARY KEY'),
('def', 'tiendaonline', 'PRIMARY', 'tiendaonline', 'imagenesproductos', 'PRIMARY KEY'),
('def', 'tiendaonline', 'PRIMARY', 'tiendaonline', 'lineaspedido', 'PRIMARY KEY'),
('def', 'tiendaonline', 'PRIMARY', 'tiendaonline', 'pedidos', 'PRIMARY KEY'),
('def', 'tiendaonline', 'PRIMARY', 'tiendaonline', 'productos', 'PRIMARY KEY');
...
('''tienda''@''localhost''', 'def', 'USAGE', 'NO'),
('''piston''@''localhost''', 'def', 'USAGE', 'NO'),
...
('localhost', 'tiendaonline', 'tienda', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
('localhost', 'bdrefaccionaria', 'piston', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
('localhost', 'tienda', '*C426B456B7481139FFF1126FC806BBD079E98D66', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'piston', '', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL);
--
...
--
CREATE DATABASE `tiendaonline` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tiendaonline`;
...
(1, 'Jose Vicente', 'Carratala', 'info@josevicentecarratala.com', 'jocarsa', 'jocarsa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Juan', 'Lopez', 'info@jocarsa.com', 'juan', 'lopez', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Jose Vicente', 'Carratala', 'JVC@hotmail.com', 'manuel', 'manuel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `imagenesproductos` (`id`, `idproducto`, `imagen`, `titulo`, `descripcion`) VALUES
(1, 1, 'lampara1a.png', 'Título 1', 'Descripción'),
(2, 1, 'lampara1b.png', 'Título de la segunda imagen', 'Descripción'),
(3, 3, 'lampara2a.png', 'Título 2', 'Descripción'),
(4, 3, 'lampara2b.png', 'Título', 'Descripción'),
(5, 4, 'lampara3a.png', 'Título', 'Descripción'),
(6, 4, 'lampara3b.png', 'Titulo', 'Descripción');
...
(1, 'Lámpara Icossaedro', 'Drescripción', '20.00', 1, 20, 20, 20, 12, 1),
(3, 'Lámpara Cubo', 'Descripción', '25.00', 1, 25, 25, 25, 20, 1),
(4, 'Lámpara Estrella', 'Descripción', '18.00', 1, 20, 20, 20, 15, 1);
